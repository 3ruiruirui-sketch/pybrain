...
def test_weight_impact():
    ...
    uniform_ensemble, _ = run_subregion_weighted_ensemble(model_list, uniform_weights, ct_data=None, ct_config=None)

    # Test 2: Subregion-optimized weights
    optimized_weights = get_default_subregion_weights(model_list)

    optimized_ensemble, _ = run_subregion_weighted_ensemble(model_list, optimized_weights, ct_data=None, ct_config=None)
...
def test_adaptive_weights():
    ...
    adaptive_weights = adaptive_subregion_weights(model_list, uncertainty_map=uncertainty_map)
