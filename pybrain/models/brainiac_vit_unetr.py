...
class BrainIACViTUNETR(nn.Module):
    ...
    def __init__(self, img_size=(96, 96, 96), patch_size=(16, 16, 16), in_channels=1, out_channels=3):
        ...
        self.patch_dim = (img_size[0] // patch_size[0]) * (img_size[1] // patch_size[1]) * (img_size[2] // patch_size[2])
        
        # Patch embedding
        self.patch_embed = nn.Conv3d(
            in_channels, 768, kernel_size=patch_size, stride=patch_size
        )
...
def integrate_brainiac_cross_validation(
    ...
    try:
        ...
        logger.info(f"BrainIAC cross-validation completed:")
